...
export default function AuthorBox({ showDescription = false }: AuthorBoxProps) {
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 my-8">
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 max-w-2xl">
        {/* Avatar */}
        <div className="flex-shrink-0">
          <Image
            src="/static/images/avatar2.jpeg"
            alt="Bhrigu Srivastava"
            width={80}
            height={80}
            className="rounded-full ring-4 ring-primary-500 dark:ring-primary-500"
          />
        </div>
