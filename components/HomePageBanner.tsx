    ...
    <section className="py-16 bg-gray-100 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg mb-8">
          I'm a software engineer passionate about web development. This blog is where I share my thoughts on technology, travel, and life.
        </p>
        <div className="relative -mx-8"> {/* Negative margin to extend beyond container */}
          <div 
            ref={carouselRef}
