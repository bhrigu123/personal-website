...
1. Socket.IO - A popular library for real-time communication. Its underlying engine powers Notion’s realtime sync.
2. Mongoose - The most popular way of accessing MongoDB data in javascript ecosystem.
